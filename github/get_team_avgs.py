...
def main():
    ...
    # Merge both DataFrames on the 'Team' column
    merged_df = pd.merge(per_game_df, advanced_df, on='Team', how='inner', suffixes=('_PerGame', '_Advanced'))
    ...
    db_server = "db-nbadata.croa2u08kkti.us-east-1.rds.amazonaws.com"
    db_name = "nba_data"
